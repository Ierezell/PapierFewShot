...
class Embedder(nn.Module):
    def __init__(self):
        ...
        self.residual1 = ResidualBlockDown(K_SHOT*3, 64)
    ...
    def forward(self, x):  # b, 12, 224, 224
        ...
        return out, paramWeights, paramBias
...
class Generator(nn.Module):
    ...
    def forward(self, img,  paramWeights, paramBias):
        ...
        x = self.ResUp2(x,
                        w1=paramWeights.narrow(0, o_r1, 64),
                        b1=paramBias.narrow(0, o_r1, 64),
                        w2=paramWeights.narrow(0, o_r1+64, 64//4),
                        b2=paramBias.narrow(0, o_r1+64, 64//4),
        ...
        x = self.ResUp3(x,
                        w1=paramWeights.narrow(0, o_r2, 32),
                        b1=paramBias.narrow(0, o_r2, 32),
                        w2=paramWeights.narrow(0, o_r2+32, 32//4),
                        b2=paramBias.narrow(0, o_r2+32, 32//4),
